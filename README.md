...
To install Prompt Server for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@kelvinzhao/mcp-prompt-server):

```bash
npx -y @smithery/cli install @kelvinzhao/mcp-prompt-server --client claude
```
